...
// Define o ID do produto correspondente ao Tênis Esportivo
$_SESSION['id_produto'] = 2;
...
<body>
    ...
    <div>  
        <a href="">
            <img src="img/TenisEsportivo.png" alt="<?php echo htmlspecialchars($nome_prod); ?>" width="300px">
        </a> 
    </div>
