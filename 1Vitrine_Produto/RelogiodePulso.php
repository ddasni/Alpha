...
// Define o ID do produto correspondente ao Relógio de Pulso
$_SESSION['id_produto'] = 3;
...
<body>
    ...
    <div>  
        <a href="">
            <img src="img/Relogio.png" alt="<?php echo htmlspecialchars($nome_prod); ?>" width="300px">
        </a> 
    </div>
